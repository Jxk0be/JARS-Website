...
<div class="w-full h-full text-black flex flex-col items-center text-center bg-white pb-[10vh]">
    ...
    <div class="grid text-white grid-cols-1 gap-y-14 md:px-[4vw] lg:px-[15vw] w-full h-full mt-[5vh] font-['Raleway']">
        ...
        <div class="flex flex-col md:hover:scale-105 transition ease-in-out duration-200 items-center justify-center w-full z-20 drop-shadow-[-5px_15px_15px_rgba(0,0,0,0.45)]">
            <div class="bg-[#36393e] md:hover:bg-[#282b30] duration-200 transition ease-in-outm md:w-[725px] md:h-[470px] w-[350px] h-[725px] relative">
                    <h1 class="mt-5 text-2xl font-semibold px-16">Who are we?</h1>
            ...
            <div class="bg-[#282b30] w-[350px] h-[50px] md:w-[725px] flex justify-center items-center">
